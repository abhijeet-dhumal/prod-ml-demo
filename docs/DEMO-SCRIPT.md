...
| Grafana (GPU + Redis metrics) | `https://grafana-smartshop.apps.oai-kft-ibm.ibm.rh-ods.com` |
| Spark History Server | `https://spark-history-smartshop.apps.oai-kft-ibm.ibm.rh-ods.com` |
| MLflow UI | `https://mlflow-ui-redhat-ods-applications.apps.oai-kft-ibm.ibm.rh-ods.com` |
...
| Attu (Milvus UI) | `https://attu-smartshop.apps.oai-kft-ibm.ibm.rh-ods.com` |
...
1. Open **MinIO Console**: `https://minio-console-smartshop.apps.oai-kft-ibm.ibm.rh-ods.com`
...
1. Open **Spark History Server**: `https://spark-history-smartshop.apps.oai-kft-ibm.ibm.rh-ods.com`
...
1. Open **Grafana**: `https://grafana-smartshop.apps.oai-kft-ibm.ibm.rh-ods.com`
...
1. Open **Feast UI**: `https://feast-smartshop-feast-ui-smartshop.apps.oai-kft-ibm.ibm.rh-ods.com`
...
1. Open **RedisInsight**: `https://redisinsight-smartshop.apps.oai-kft-ibm.ibm.rh-ods.com`
...
1. Open **MLflow UI**: `https://mlflow-ui-redhat-ods-applications.apps.oai-kft-ibm.ibm.rh-ods.com`
...
```
NAME              URL                                                     READY
smartshop-rec     https://smartshop-rec-smartshop.apps.oai-kft-ibm...   True
smartshop-llm     https://smartshop-llm-smartshop.apps.oai-kft-ibm...   True
smartshop-rag     https://smartshop-rag-smartshop.apps.oai-kft-ibm...   True
```
